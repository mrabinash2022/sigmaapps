...
const styles = StyleSheet.create({
  ...
  brand: { fontSize: 36, fontWeight: '800', color: '#1a7f4b', textAlign: 'center' },
  tagline: { fontSize: 14, color: '#666', textAlign: 'center', marginBottom: 24, marginTop: 8 },
  tabRow: { flexDirection: 'row', marginBottom: 20, gap: 8 },
  tab: { flex: 1, padding: 12, borderRadius: 10, borderWidth: 1, borderColor: '#ddd', alignItems: 'center', backgroundColor: '#fff' },
  tabActive: { borderColor: '#1a7f4b', backgroundColor: '#e8f5ee' },
  ...
  roleBtn: { flex: 1, padding: 12, borderRadius: 10, borderWidth: 1, borderColor: '#ccc', alignItems: 'center', backgroundColor: '#fff' },
  roleActive: { borderColor: '#1a7f4b', backgroundColor: '#e8f5ee' },
  captchaBox: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#e5e7eb', borderRadius: 10, padding: 12, marginBottom: 12 },
  captchaLabel: { fontSize: 13, fontWeight: '700', color: '#444', marginBottom: 6 },
  captchaQuestion: { fontSize: 16, fontWeight: '600', color: '#1a7f4b', marginBottom: 8 },
  verifyBox: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#c8e6d4', borderRadius: 10, padding: 12, marginBottom: 12 },
  verifyTitle: { fontSize: 15, fontWeight: '700', color: '#1a7f4b', marginBottom: 4 },
  hint: { fontSize: 13, color: '#666', marginBottom: 10 },
  verifiedText: { fontSize: 13, color: '#1a7f4b', fontWeight: '600', marginBottom: 8 },
  btn: { backgroundColor: '#1a7f4b', padding: 16, borderRadius: 10, alignItems: 'center', marginTop: 8 },
  btnDisabled: { backgroundColor: '#9ca3af' },
  verifyBtn: { backgroundColor: '#1a7f4b', padding: 14, borderRadius: 10, alignItems: 'center', marginBottom: 4 },
  secondaryBtn: { borderWidth: 1, borderColor: '#1a7f4b', padding: 14, borderRadius: 10, alignItems: 'center', marginTop: 8, backgroundColor: '#fff' },
  secondaryBtnText: { color: '#1a7f4b', fontWeight: '700' },
  btnText: { color: '#fff', fontWeight: '700', fontSize: 16 },
  link: { color: '#1a7f4b', textAlign: 'center', marginTop: 16, fontWeight: '600' },
  devBox: {
    marginTop: 28,
    borderWidth: 1,
    borderColor: '#fcd34d',
  ...
  devToggleText: { fontSize: 14, fontWeight: '700', color: '#92400e' },
  devContent: { paddingHorizontal: 14, paddingBottom: 14, gap: 10 },
  devNote: { fontSize: 13, fontWeight: '600', color: '#78350f', lineHeight: 18 },
  devHint: { fontSize: 12, color: '#a16207', lineHeight: 17 },
  devCard: {
    backgroundColor: '#fff',
    borderWidth: 1,
    borderColor: '#fde68a',
  ...
  devRole: { fontSize: 14, fontWeight: '700', color: '#1a7f4b', marginBottom: 4 },
  devLine: { fontSize: 12, color: '#444', lineHeight: 18 },
  devTap: { fontSize: 11, color: '#1a7f4b', fontWeight: '600', marginTop: 6 },
  devSubToggle: { paddingVertical: 6 },
  devSubToggleText: { fontSize: 13, fontWeight: '700', color: '#92400e' },
  devShopList: {
    backgroundColor: '#fff',
    borderWidth: 1,
    borderColor: '#fde68a',
  ...
  devShopPhone: { fontSize: 12, fontWeight: '700', color: '#333', width: 88 },
  devShopName: { fontSize: 12, color: '#555', flex: 1 },
});
